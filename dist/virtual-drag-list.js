...
(function (global, factory) {
  ...
  var VirtualList = Vue__default["default"].component('virtual-list', {
    ...
    beforeDestroy: function beforeDestroy() {
      ...
      (_this$sortableRef = this.sortableRef) === null || _this$sortableRef === void 0 || _this$sortableRef.destroy();
      (_this$virtualRef = this.virtualRef) === null || _this$virtualRef === void 0 || _this$virtualRef.removeScrollEventListener();
    },
    methods: {
      /**
      ...
      _onUpdate: function _onUpdate() {
        ...
        (_this$sortableRef2 = this.sortableRef) === null || _this$sortableRef2 === void 0 || _this$sortableRef2.option('list', this.dataSource);
      ...
      _updateUniqueKeys: function _updateUniqueKeys() {
        ...
        (_this$virtualRef2 = this.virtualRef) === null || _this$virtualRef2 === void 0 || _this$virtualRef2.option('uniqueKeys', this.uniqueKeys);
        (_this$sortableRef3 = this.sortableRef) === null || _this$sortableRef3 === void 0 || _this$sortableRef3.option('uniqueKeys', this.uniqueKeys);
      },
      _updateRange: function _updateRange(oldList, newList) {
        ...
        (_this$virtualRef3 = this.virtualRef) === null || _this$virtualRef3 === void 0 || _this$virtualRef3.updateRange(range);
      },
      ...
      _installVirtual: function _installVirtual() {
        ...
        this.virtualRef = new Virtual(_objectSpread2(_objectSpread2({}, this.virtualAttributes), {}, {
          ...
          onUpdate: function onUpdate(range) {
            var _this4$sortableRef;
            var rangeChanged = range.start !== _this4.range.start;
            if (_this4.dragging && rangeChanged) {
              _this4.sortableRef.reRendered = true;
            }
            _this4.range = range;
            (_this4$sortableRef = _this4.sortableRef) === null || _this4$sortableRef === void 0 || _this4$sortableRef.option('range', range);

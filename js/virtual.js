    ...
    return h(
      ...
      [
        h(
          ...
          [
            h('button', { on: { click: this.disabledChange } }, 'allow drag: ' + !this.disabled),
        ...
        h(
          ...
          [
            this.loading && this.topLoad && h('div', { slot: 'header' }, [h(VirtualLoading)]),
            this.bottomLoad && h('div', { slot: 'footer' }, [h(VirtualLoading)]),
          ]
        ),
      ]
    )
